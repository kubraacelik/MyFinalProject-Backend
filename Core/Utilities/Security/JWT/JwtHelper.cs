...
namespace Core.Utilities.Security.JWT
{
    public class JwtHelper : ITokenHelper
    {
        ...
        public JwtHelper(IConfiguration configuration)
        {
            ...
            _tokenOptions = Configuration.GetSection("TokenOptions").Get<TokenOptions>(); //appsettings'deki "Token Options" bölümünü al
                                                                                          //benim yazdığım TokenOptions bölümünü alarak birbirine ata
